            ...
            {(formik) => {
                return (
                    <div className="addveh">
                        <Navbar /><br /><br />
                        <div className="row">
                            <div className="col-md-4" style={{marginLeft:'50px', marginTop:'50px', width:'250px'}}>
                            ...
                            <div className="col-md-1"style={{ marginTop: '100px' }}>
                                    <input
                                        type="file"
                                        id="file"
                                        multiple
                            ...
                            <Form >
                            <div className="container " style={{ marginTop: '10px', marginLeft: '50px' }}>
